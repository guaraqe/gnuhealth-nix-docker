let
  ...
  bower2nix = pkgs.callPackage ./nix/bower2nix.nix {};
  tryton-sao = pkgs.callPackage ./nix/tryton-sao {};
  trytond = pkgs.python39Packages.callPackage ./nix/trytond.nix {
    sao = tryton-sao;
    modules =
      # Base modules
...
in
  { inherit bower2nix trytond tryton-sao; }
